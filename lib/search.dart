...
class BookDetailsScreen extends StatelessWidget {
  ...
  void _addToCart(BuildContext context) {
    if (book['availability'] == 'No') {
      _showBookNotAvailableDialog(context);
    } else {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Checkout(books: [book]),
        ),
      );
    }
  }

  void _showBookNotAvailableDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Book Not Available'),
          content: Text('Sorry, this book is currently not available.'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
